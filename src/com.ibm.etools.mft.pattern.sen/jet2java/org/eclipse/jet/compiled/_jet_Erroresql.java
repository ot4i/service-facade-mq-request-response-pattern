...
com.ibm.etools.mft.pattern.sen.sf.synchmq.PatternMessages messages = new com.ibm.etools.mft.pattern.sen.sf.synchmq.PatternMessages();
        ...
        out.write(NL);         
        out.write(NL);         
        out.write("CREATE FILTER MODULE CheckRR_Mode");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\tCREATE FUNCTION Main() RETURNS BOOLEAN");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\tBEGIN");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t-- This determines whether a fault is returned");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t-- Faults only apply to request flow");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\tIF Environment.PatternVariables.RRMode = 'Response' THEN");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write(NL);         
        out.write("\tSET OutRef.StatusCode = Environment.PatternVariables.StatusCode;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t");  //$NON-NLS-1$        
        ...
        out.write( pattern.getString("com.ibm.etools.mft.pattern.sen.sf.synchmq.esql.1") );
        out.write("';");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write( pattern.getString("com.ibm.etools.mft.pattern.sen.sf.synchmq.esql.2") );
        out.write(" ' || COALESCE(Label, ''); ");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t\t\tSET FaultText = FaultText || ' ");  //$NON-NLS-1$        
        out.write( pattern.getString("com.ibm.etools.mft.pattern.sen.sf.synchmq.esql.3") );
        out.write(" ' || COALESCE(CAST(Error AS CHARACTER), '');");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t\t\tSET FaultText = FaultText || ' ");  //$NON-NLS-1$        
        out.write( pattern.getString("com.ibm.etools.mft.pattern.sen.sf.synchmq.esql.4") );
        out.write(" ' || COALESCE(Text, '');");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t\t\tSET FaultText = FaultText || ' ");  //$NON-NLS-1$        
        out.write( pattern.getString("com.ibm.etools.mft.pattern.sen.sf.synchmq.esql.8") );
