...
com.ibm.etools.mft.pattern.sen.sf.synchmq.PatternMessages messages = new com.ibm.etools.mft.pattern.sen.sf.synchmq.PatternMessages();
        ...
        out.write(NL);         
        out.write("\t\tIF ResponseLoggingOn AND (Environment.PatternVariables.RRMode = 'Response') THEN RETURN TRUE;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tEND IF;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tIF RequestLoggingOn AND (Environment.PatternVariables.RRMode <> 'Response') THEN RETURN TRUE;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tEND IF;");  //$NON-NLS-1$        
        out.write(NL);         
        ...
        out.write("    IF Environment.PatternVariables.RRMode = 'Request'THEN");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    SET EnvVarRef.SOAPVersion = InputRoot.SOAP.Context.SOAP_Version;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    SET EnvVarRef.ServiceName = InputRoot.SOAP.Context.service;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    SET EnvVarRef.ServiceNameSpace = InputRoot.SOAP.Context.Namespace;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    SET EnvVarRef.ServicePort = InputRoot.SOAP.Context.port;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    SET EnvVarRef.ServicePortType = InputRoot.SOAP.Context.portType;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    SET EnvVarRef.ServiceOperation = InputRoot.SOAP.Context.operation;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("    END IF;");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("END;");  //$NON-NLS-1$        
